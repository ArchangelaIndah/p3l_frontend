<template>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">HISTORI DEPOSIT KELAS</h1>
    </div>
...
export default {
    ...
    setup() {
        const headers = ref([
            ...
            { text: "TOTAL_DEPOSIT", value: "total_deposit", sortable: true },
        ...
        onMounted(() => {
            loading.value = true
            axios.get('https://jollyvm2.eastus.cloudapp.azure.com/git/p3l_dian/public/api/historiDepositKelas').then(response => {
                loading.value = false
