...
export default {
    ...
    setup() {
        const headers = ref([
            ...
            { text: "AKTIVASI TAHUNAN", value: "total", sortable: true },
            { text: "METODE_PEMBAYARAN", value: "metode_pembayaran", sortable: true },
        ...
        onMounted(() => {
            loading.value = true
            axios.get('https://jollyvm2.eastus.cloudapp.azure.com/git/p3l_dian/public/api/historiAktivasi').then(response => {
                loading.value = false
